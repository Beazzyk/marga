...
<div style="background-image: url(&quot;cave04.png&quot;);" id="battleplace"><div><div style="border: medium none; visibility: visible; display: block; left: 240px; top: 154px; background-position: 0px 48px; z-index: 378; background-image: url(&quot;<?php echo $postac['obrazek']; ?>&quot;);" id="UID_dab7c0" class="cItem"></div></div><div><img src="http://game9.margonem.pl/obrazki/npc/hum/klan_dow.gif" style="border: 1px solid red; visibility: hidden; display: none; left: 239px; top: 161px; z-index: 376;" class="cItem"></div><div><img src="bestia64.gif" style="border: 1px solid red; visibility: visible; display: block; left: 240px; top: 121px; z-index: 374;" id="mob" class="cItem"></div></div>
...
<div style="background-position: 0pt 0pt;" id="bt_use" onclick="dofight('useskill')" rollover="19"></div>
<div style="background-position: 0pt -38px;" id="closebattle" onclick="dofight('zamknij')"></div>
</div>

<div id="battlein"></div></div>
