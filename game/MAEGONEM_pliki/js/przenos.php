...
mysql_query("update postac set mapa = 68, x = 40, y = 40 where id = ".$postac['id']." limit 1");
echo true;
exit;
} elseif($_POST['id'] == 5){
mysql_query("update postac set mapa = 115, x = 35, y = 35 where id = ".$postac['id']." limit 1");
echo true;
exit;
} elseif($_POST['id'] == 6){
mysql_query("update postac set mapa = 147, x = 30, y = 30 where id = ".$postac['id']." limit 1");
echo true;
exit;
