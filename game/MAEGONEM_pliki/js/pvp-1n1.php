...
$potwor = mysql_fetch_array(mysql_query("select * from postac where id = ".$_POST['id']." and mapa = ".$postac['mapa']." and (x = ".($postac['x'] - 1)." or x = ".($postac['x'] + 1)." or x = ".$postac['x'].") and (y = ".($postac['y'] - 1)." or y = ".($postac['y'] + 1)." or y = ".$postac['y'].") and respawn <= ".$czas_ogolny." limit 1"));
$mob = mysql_fetch_array(mysql_query("select * from postac where id = ".$_POST['id']." and respawn <= ".$czas_ogolny." limit 1"));
...
// KOD G£ÓWNY //   
  ...
  $tura[od_p] = 0;
  if($potwor['profesja'] == 'Mag') $tura[od_m] = 1;
  elseif($potwor['profesja'] == 'Lowca' || $potwor['profesja'] == 'Tropiciel') $tura[od_m] = 2;
  else $tura[od_m] = 0;
  ...
  if($mob['zycie'] <= 0){
    ...
    mysql_query("update postac set ph = ph - ".$wygrana.", mapa = ".$mapa['dead_map'].", x = ".$mapa['dead_x'].", y = ".$mapa['dead_y']." where id = ".$mob['id']." limit 1");
