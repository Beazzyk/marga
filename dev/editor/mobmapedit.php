<?php
     ...
     if(!empty($_SESSION['mapa'])){
                     ...
                     echo "<iframe border=0 src='mobedytor.php' style='width: 100%; height: 600px;'></iframe>";
                     echo "<form action='mobmapedit.php?edit=end' method='post'>
            ...
            echo "<form action='mobmapedit.php' method='post'>Wybierz Mapê:<br>";
