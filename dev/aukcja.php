...
<a href='index.php?do=auction&baza=devmargo&id=".$_GET['id']."&a=wystaw&id2=".$dane['id']."' onmouseover=pokaz_item('oTip_item_".$dane['id']."'); onclick=zaloz('".$dane['id']."'); onmouseout=schowaj_item('oTip_item_".$dane['id']."');><div>
...
$ajax_txt .= "<hr><a href='index.php?do=auction&baza=devmargo&id=".$_GET['id']."' style='position: absolute; top: 80%;'>Powrót</a>";
$ajax_txt .= "</div>";
...
url(game/MAEGONEM_pliki/".$dane['obrazek'].");'
 ...
 $ajax_txt .= "<hr><a href='index.php?do=auction&baza=devmargo&id=".$_GET['id']."&a=wystaw' style='position: absolute; top: 80%;'>Powrót</a>";
 echo $ajax_txt;
 echo "<div style='position: absolute; top: 64px;'>
         <form action='index.php?do=auction&baza=devmargo&id=".$_GET['id']."&a=wystaw&id2=".$_GET['id2']."' method='post'>
...
<a href='index.php?do=auction&baza=devmargo&id=".$_GET['id']."&a=przegl&kup=".$dane['id']."' onmouseover=pokaz_item('oTip_item_".$dane['id']."'); onclick=zaloz('".$dane['id']."'); onmouseout=schowaj_item('oTip_item_".$dane['id']."');><div>
<div style='top: ".$top_piksel."px; left: ".$left_piksel."px; background-color: transparent; background-image: 
url(MAEGONEM_pliki/".$dane['obrazek'].");'
 id=UID_763bb8 class='cequip'></div></div></a>";
...
echo $ajax_txt;
        ...
        $_SESSION['player'] = 0;
        echo "Wylogowano.
        <a href='index.php?do=auction&baza=devmargo&id=".$_GET['id']."'>Odswie¿</a>";
} else {
       echo "
              <a href='index.php?do=auction&baza=devmargo&id=".$_GET['id']."&a=wystaw'>Wystaw Przedmiot na Aukcje</a><br>
              <a href='index.php?do=auction&baza=devmargo&id=".$_GET['id']."&a=przegl'>Przegladaj Aukcje</a><br>
       ";
}
}
?>
