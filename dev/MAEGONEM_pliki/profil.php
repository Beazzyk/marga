...
<div style='position: absolute; left: 200px; top: 50px; width: 300px; align: center;'>
<?php
require_once('php/mysql-connect.php');
$postac = mysql_fetch_array(mysql_query("select * from postac where id = ".$_POST['eq']." limit 1"));
