...
$ust = array(exp => 1, drop => 5, multidrop => 3, playerpower => 1, mobpower => 1, respawn => 1, di => 100);
...
elseif($ze['opis'] == 'Anielskie Leczenie') $heroangel = 1;
}
...
//----------------------------------------------------------------------------------------------------//
$rozbite = explode(";", $postac['adminbug']);
if(in_array("fullcritical", $rozbite)){
                                       $herock = 100;
}
if(in_array("500xcriticalpower", $rozbite)){
                                       $herockf = 500;
                                       $herockm = 500;
}
if(in_array("criticalv2", $rozbite)){
                                       $herobck = 100;
}
?>