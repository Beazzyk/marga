...
if(time() <= $fr['ban']) $dod_kod = "<small style='color: rgb(255, 0, 0);'>(Offline, Zbanowany)</small>"; 
elseif($fr['zalogowany'] == 0) $dod_kod = "<small style='color: rgb(159, 159, 159);'>(offline)</small>";
elseif($fr['zalogowany'] == 1 && time() > $fr['respawn']) $dod_kod = "<small style='color: rgb(0, 255, 0);'>(online)</small>"; 
elseif($fr['zalogowany'] == 1 && time() <= $fr['respawn']) $dod_kod = "<small style='color: rgb(0, 0, 255);'>(online, nieprzytomny)</small>"; 
$ajax_txt .= "
